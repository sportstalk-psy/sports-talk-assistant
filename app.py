...
system_prompt = (
    ...
    "Во всех случаях, когда нужно выделить текст жирным (будь то имена или пункты рекомендаций), используй HTML-тег `<strong>…</strong>`, а не Markdown `**…**`.\n"
    "При выводе ссылки на профиль психолога используй HTML-ссылки с inline-стилем цвета #ebf5ff:\n"
