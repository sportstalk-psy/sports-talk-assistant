...
def chat():
    try:
        ...
        system_prompt = (
            ...
            "Никогда не придумывай имена или описания специалистов. Не предлагай вымышленных психологов. Все рекомендации специалистов формируются отдельно платформой Sports Talk на основе внутренней базы данных. Ты не отвечаешь за подбор конкретных специалистов. Твоя задача — отвечать на вопросы по теме спортивной психологии и передавать инициативу выбора на платформу."
